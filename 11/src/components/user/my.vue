...
export default {
    data(){
        return{
            ...
            uploadUrl: 'http://upload.qiniup.com/putb64/-1/',
        }
    },
    components: {
        VueCrop
    ...
    methods: {
        ...
        uploadSuccess( res ){
            ...
            var params = {
                ...
                headImg : "http://curtaintan.club/" + res.key
            }
            this.$api.users.QnAfHeadImg( params ).then( res =>{
                if( res ){
                    this.$Message.info({
                        content: '修改成功.....',
                        duration: 3
                    });
                    this.upHeadImg( res.data.headImg )
                }else{
                    this.$Message.info({
                        content: '修改失败.....',
                        duration: 3
