        ...
        <Carousel autoplay v-model="value2" loop>
            <CarouselItem>
                <div class="demo-carousel">
                    <a href="https://cn.vuejs.org/"><img src="../../assets/l3.png" alt=""></a>
                </div>
            </CarouselItem>
            <CarouselItem>
                <div class="demo-carousel">
                    <router-link to="/css"><img src="../../assets/l4.png" alt=""></router-link>
                </div>
            </CarouselItem>
            <CarouselItem>
                <div class="demo-carousel">
                    <router-link to="/map"><img src="../../assets/67.png" alt=""></router-link>
                </div>
            </CarouselItem>
            <CarouselItem>
                <div class="demo-carousel">
                    <router-link to="/json"><img src="../../assets/j.jpg" alt=""></router-link>
                </div>
            </CarouselItem>
            <CarouselItem>
                <div class="demo-carousel">
                    <router-link to="/chart"><img src="../../assets/l6.png" alt=""></router-link>
                </div>
            </CarouselItem>
        </Carousel>
        <div class="newsMain">
